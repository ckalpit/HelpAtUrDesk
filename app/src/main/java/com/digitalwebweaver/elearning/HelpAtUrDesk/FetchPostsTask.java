...
//            int count = questionAnswerInfoJson.getInt(QUESTION_ANSWER_OBJECT_COUNT);
            ...
            if (cVVector.size() > 0) {
                ...
                inserted = mContext.getContentResolver().bulkInsert(BlogPostContract.BlogPostEntry.CONTENT_URI, cvArray);
            }

            Log.w(LOG_TAG, "FetchWeatherTask Complete. " + inserted + " Inserted");
